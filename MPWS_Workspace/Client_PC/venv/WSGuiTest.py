...
class TEST(tk.Tk):
    def __init__(self, client_pc):
        ...
        # Create label
        self.label_messg = tk.Label(self, text="Please choose protocol:", font=12, width=43, height=2)
    ...
    def animate(self, i):
        if self.client_pc.AM2320_HUMIDITY and self.client_pc.AM2320_TEMPERATURE and self.client_pc.LPS25HB_PRESSURE and self.client_pc.LPS25HB_TEMPERATURE != 0:  # wait for measurement after start program
            ...
            self.ax2.clear()
            self.ax2.plot(self.xs, self.ys2)
            ...
            self.ax3.clear()
            self.ax3.plot(self.xs, self.ys3)
            ...
            self.ax4.clear()
            self.ax4.plot(self.xs, self.ys4)
